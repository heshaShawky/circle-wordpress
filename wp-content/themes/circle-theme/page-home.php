        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div id="owl-demo" style="overflow:hidden">
                    <?php for ($i=1; $i <= 8; $i++) : ?>
                    <div class="item">
                        <img class="img-responsive" src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/owl<?php echo $i ?>.jpg" alt="Owl Image" data-pin-nopin="true">

                        <div class="item-links">
                            <ul class="list-inline">
                                <li class="zoom-gallery">
                                    <a class="image-popup-no-margins" href="<?php bloginfo('stylesheet_directory'); ?>/assets/images/owl<?php echo $i ?>.jpg" title="Caption. Can be aligned to any side and contain any HTML.">
                    ...
                    <div class="item">
                        ...
                        <div class="post-info clearfix">
                            <div class="col-xs-4 text-center">
                                <img class="img-responsive user" src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/admin.jpg" alt="" style="max-width:70px;" />
                                By <a href="#">Admin</a>
                            </div>
