...
<section class="hero" style="height: auto; color:#fff; ">
    <div class="container">
        <div class="raw">
            <h2 class="text-uppercase" style="font-weight: bold;"><?php the_title() ?></h2>
        </div>
    </div>
</section>
...
<section class="recent">
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <h3 class="text-uppercase">our stuff</h3><br />
                <p>
            ...
            <div class="col-sm-9">
                <div id="owl-demo" style="overflow:hidden">
                    <?php
                    $loops = new WP_Query(array('post_type'=>'our_stuff', 'orderby'=>'rand'));
                    ...
                    <div class="item">
                        ...
                        <div class="item-info" style="height:100%">
